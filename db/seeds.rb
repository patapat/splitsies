...
UserTab.create!(user_id: 5, tab_id: 1, amount_owed: 6.05)
UserTab.create!(user_id: 2, tab_id: 2, amount_owed: 10.00)
UserTab.create!(user_id: 3, tab_id: 2, amount_owed: 15.00)
UserTab.create!(user_id: 4, tab_id: 3, amount_owed: 13.14)
UserTab.create!(user_id: 1, tab_id: 4, amount_owed: 45.00)
UserTab.create!(user_id: 1, tab_id: 5, amount_owed: 445.00)
UserTab.create!(user_id: 2, tab_id: 6, amount_owed: 15.00)
